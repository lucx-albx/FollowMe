    ...
    return (
        <Menu isOpen={isMenuOpen} onStateChange={({ isOpen }) => setIsMenuOpen(isOpen)} width={'280px'}>
            <NavLink className="menu-item" to={"/Informazioni"} onClick={toggleMenu}>
                <FontAwesomeIcon icon={faCircleInfo} style={{ textDecoration: 'none', color: 'black' }} className='pointer'/>&nbsp;&nbsp;Information
            </NavLink>
            ...
            <NavLink className="menu-item" to={"/Permessi"} onClick={toggleMenu}>
                <FontAwesomeIcon icon={faCamera} style={{ textDecoration: 'none', color: 'black' }} className='pointer'/>&nbsp;&nbsp;Camera's permisiion
            </NavLink>

            <NavLink className="menu-item" to={"/Impostazioni"} onClick={toggleMenu}>
                <FontAwesomeIcon icon={faGear} style={{ textDecoration: 'none', color: 'black' }} className='pointer'/>&nbsp;&nbsp;Configure
            </NavLink>
        </Menu>
    )
}
